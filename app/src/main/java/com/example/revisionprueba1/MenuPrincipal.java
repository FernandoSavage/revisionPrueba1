...
public class MenuPrincipal extends AppCompatActivity {
    ...
    public void cargarTarjeta(View view){
        ...
        if(tarjeta.cargarChip(cantidad)){
            ...
            Toast.makeText(this,"Las recargas deben ser iguales o mayores a $1000", Toast.LENGTH_SHORT).show();
        }
    ...
    public void comprarPasajeMetro(View view){
        if (tarjeta.comprarPasajeMetro()){
            Toast.makeText(this,"Compra de pasaje en metro correcta", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    public void comprarPasajeTaxi(View view){
        if (tarjeta.comprarPasajeTaxi()){
            Toast.makeText(this,"Compra de pasaje en taxi correcta", Toast.LENGTH_SHORT).show();
        }
        else{
